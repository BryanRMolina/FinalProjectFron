        ...
        <div className="square">
            ...
            <div className="squarecard">
                <SquaresData
                    ...
                    text="Antes de donar sangre, se realiza una 
                    evaluación médica completa que incluye pruebas de detección 
                    de enfermedades infecciosas. Esto puede brindarte información 
                    valiosa sobre tu estado de salud, ya que se realizan pruebas para 
                    detectar enfermedades como hepatitis, VIH y otras infecciones transmitidas 
                    por la sangre. Es una oportunidad 
                    para hacer un chequeo general de tu salud de manera gratuita."
                />
